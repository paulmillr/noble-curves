...
export type H2CHasherBase<PC extends PC_ANY> = {
  ...
  /**
   * Derive one curve point from non-uniform bytes without the random-oracle guarantees of `hashToCurve`.
   * @param msg - Input message bytes.
   * @param options - Optional domain-separation override. See {@link H2CDSTOpts}.
 ...
 * const uniform = expand_message_xof(new TextEncoder().encode('hello noble'), 'DST', 32, 128, shake256);
 * ```
 */
 ...
 * @param msg - Input message bytes.
 * @param count - Number of field elements to derive.
 * @param options - RFC 9380 options. See {@link H2COpts}.
...
export const _DST_scalar: Uint8Array = /* @__PURE__ */ asciiToBytes('HashToScalar-');

/**
 * Creates hash-to-curve methods from EC Point and mapToCurve function. See {@link H2CHasher}.
 * @param Point - Point constructor.
 * @param mapToCurve - Map-to-curve function.
 * @param defaults - Default hash-to-curve options.
