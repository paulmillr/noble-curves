...
import { FpInvertBatch, isNegativeLE, mod, pow2, type IField } from './abstract/modular.ts';
...
const Fp = /* @__PURE__ */ (() => FieldWasmBigint(ed448_CURVE_p, { BITS: 456, isLE: true }))();
// Same 57-byte container shape as `Fp`; canonical scalar encodings still have
// the top ten bits clear per RFC 8032.
const Fn = /* @__PURE__ */ (() => FieldWasmBigint(ed448_CURVE.n, { BITS: 456, isLE: true }))();
...
const Fp448 = /* @__PURE__ */ (() => FieldWasmBigint(ed448_CURVE_p, { BITS: 448, isLE: true }))();
// Strict 56-byte scalar parser matching RFC 9496's recommended canonical form.
const Fn448 = /* @__PURE__ */ (() => FieldWasmBigint(ed448_CURVE.n, { BITS: 448, isLE: true }))();
