...
(async () => {
  ...
  const multi = {
    zero: {
      got: () => msm([g1.BASE, g1.BASE, g1.BASE, g1.BASE, g1.BASE], zeroes),
      want: () => sum([g1.BASE, g1.BASE, g1.BASE, g1.BASE, g1.BASE], zeroes),
    },
    zero2: {
      got: () => msm([g1.ZERO, g1.ZERO, g1.ZERO, g1.ZERO, g1.ZERO], zeroes),
      want: () => sum([g1.ZERO, g1.ZERO, g1.ZERO, g1.ZERO, g1.ZERO], zeroes),
    },
  ...
  const mul = {
    ...
    'onezero*G1': {
      got: () => g1.BASE.multiply(onezero),
      want: () => g1.BASE.multiplyUnsafe(onezero),
    },
    'one8zero*G1': {
      got: () => g1.BASE.multiply(one8zero),
      want: () => g1.BASE.multiplyUnsafe(one8zero),
    },
